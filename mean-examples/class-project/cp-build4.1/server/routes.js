...
var express = require('express'),
	...
	items = require('../controllers/user/items');
...
module.exports = function(app){
	...
	/* SCRIPTS FOR THE ADDITIONAL SESSION ROUTES */
	router.get('/user/add_books', items.getBooksList);
	router.post('/user/update_book_list', items.updateBooksList);
	router.get('/user/add_movies', items.getMoviesList);
	router.post('/user/update_movie_list', items.updateMoviesList);
